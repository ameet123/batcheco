...
/**
 * specific component to perform HDFS move
 * it should only be repsonsible for file movement to HDFS and not much else
 * @author ac2211
 *
 */
@Component
public class MoveToHdfs {
	 ...
	 * @param localFile file name on local machine to copy
	 * @param remotePath is a directory in which the file needs to be copied
	 * @return
	 */
